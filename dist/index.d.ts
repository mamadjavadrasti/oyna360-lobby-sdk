export declare const LOBBY_SDK_BUILD = "avatar-opt-v11";
...
export type { LobbyPerfSnapshot, LobbyPerfSampleSeries, LobbyPerfDiagHandle, LobbyPerfPhase, LobbyPerfPhaseStat, } from './lobby-perf-diag';
