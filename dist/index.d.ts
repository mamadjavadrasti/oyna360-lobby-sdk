export declare const LOBBY_SDK_BUILD = "avatar-join-v13";
...
export { attachLobbyPerfDiag, captureLobbyPerfSnapshot, sampleLobbyPerf, setLobbyPerfDiagEnabled, resetLobbyPerfDiag, isLobbyPerfDiagEnabled, diagSetAlwaysSelectAsActiveMesh, diagSetAvatarDoubleSide, diagSetDisableUniformBuffers, getLobbyPerfPhaseSummary, captureLobbyPerfMemory, collectLobbyAvatarCosts, extractSpawnTimelineFromMarks, summarizeAvatarRenderCosts, sampleAvatarRender, captureWebGlInfo, } from './lobby-perf-diag';
export type { LobbyPerfSnapshot, LobbyPerfSampleSeries, LobbyPerfDiagHandle, LobbyPerfPhase, LobbyPerfPhaseStat, LobbyPerfPhaseDist, LobbyPerfMemoryInfo, LobbyPerfAvatarCost, AvatarRenderCostSummary, AvatarRenderSample, } from './lobby-perf-diag';
export { attachRealDeviceAvatarDiag, captureRealDeviceInfo, runRealDeviceAvatarSuite, } from './lobby-real-device-diag';
export type { RealDeviceLobbyBridge, RealDeviceSuiteOptions, RealDeviceAvatarReport, RealDeviceInfo, } from './lobby-real-device-diag';
export { attachPlazaDiag, runPlazaDiagSuite, inventoryPlazaSubsystems, classifyPlazaMesh, PLAZA_MESH_SUBSYSTEMS, } from './lobby-plaza-diag';
export type { PlazaSubsystemId, PlazaSubsystemInventory, PlazaDiagReport, PlazaDiagSuiteOptions, PlazaDiagSample, } from './lobby-plaza-diag';
